...
export default function SyncPairCard({ ytPlaylistTitle, spotifyPlaylistTitle, totalSongs }: { ytPlaylistTitle: string; spotifyPlaylistTitle: string; totalSongs: number }) {
    ...
    return (
        <div onClick={() => router.push('/Dashboard/SyncScreen/1')} className="w-full p-5 border-2 border-(--line) hover:cursor-pointer hover:border-(--syncwave) flex-col gap-3.5 rounded-2xl bg-(--bg-surface) h-fit flex transition-all duration-300 ease-in-out hover:scale-[1.01]">
            <div className="flex justify-start gap-2">
                ...
                <p className="text-sm self-center w-fit">{ytPlaylistTitle}</p>
                ...
                <div className="ml-auto hidden lg:flex justify-center items-center gap-2 self-center">
                    <BlinkingDot width={10} height={10} color="bg-green-500"></BlinkingDot>
            ...
            <div className="flex gap-1">
                ...
                <div className="lg:hidden ml-auto flex justify-center items-center gap-2 self-center">
                    <BlinkingDot width={10} height={10} color="bg-green-500"></BlinkingDot>
                    <p className="text-sm text-(--text-muted)">Syncing</p>
                </div>
            </div>
